                                                  ...
                                                  child: SingleChildScrollView(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: 30.h),
                                                        MyText(text: 'Nurse Name: ${nurseMap2['Nurse Name']}', size: 50.sp, overflow: false, bold: false, color: Colors.black),
                                                        ...
                                                        SizedBox(height: 20.h),
                                                        MyText(text: 'Mobile Number: ${nurseMap2['Mobile Number']}', size: 50.sp, overflow: false, bold: false, color: Colors.black),
                                                        SizedBox(height: 30.h),
                                                        Divider(color: Colors.grey,thickness: 3.sp),
                                                      ],
                                                    ),
